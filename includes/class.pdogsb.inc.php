...
class PdoGsb
{
            ...
            
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            ...
            . 'FROM visiteur '
            . 'WHERE visiteur.login = :unLogin AND visiteur.mdp = :unMdp and visiteur.comptable = 0'
        );
    ...
    public function getInfosComptable($login, $mdp)
    {
		...
		$requetePrepare = PdoGsb::$monPdo->prepare(
            ...
            . 'visiteur.prenom AS prenom '
            . 'FROM visiteur '
            . 'WHERE visiteur.login = :unLogin AND visiteur.mdp = :unMdp and visiteur.comptable = 1'
			 );
